...
if __name__ == "__main__":
    ...
    # You can try to change the hyper-parameters to see what will happen.
    ...
    # If you want to get the baseline of the SVM algorithm, you should install the scikit-learn package (pip install scikit-learn).
